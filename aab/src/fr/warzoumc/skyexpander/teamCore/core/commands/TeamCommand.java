        ...
        if (sender instanceof Player){
            ...
            if (args.length == 2){
                if (args[0].equalsIgnoreCase("create")){
                    ...
                    if (args[1].equalsIgnoreCase(UUID.nameUUIDFromBytes(Team.fromPlayer(main, player).getTeamName().getBytes()).toString())){
                 ...
                 if (args[0].equalsIgnoreCase("leave")) {
                    new Leaving(main, player);
                     ...
                     if (Team.fromPlayer(main, player) != null){
                         ...
                         textComponent.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/team disband " + UUID.nameUUIDFromBytes(Team.fromPlayer(main, player).getTeamName().getBytes())));
